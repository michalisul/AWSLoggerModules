...
class TestUnittestAssertions(unittest.TestCase):
    ...
    # AnalogSensor
    def test_analog_sensor_IsInstance(self):
        self.test_analog_sensor = AnalogSensor(32)
        self.assertIsInstance(self.test_analog_sensor, AnalogSensor)

    def test_analog_sensor_readings(self):
        self.test_analog_sensor = AnalogSensor(32)
        self.readings = self.test_analog_sensor.analog_read()
        print(self.readings)
        self.assertEqual(self.readings, 4095)
